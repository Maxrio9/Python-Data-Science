...
# Fit model1
model1 = sm.OLS.from_formula("price ~ type + sqfeet + beds + baths", housing).fit()
# Fit model2
model2 = sm.OLS.from_formula("price ~ type + sqfeet + beds + baths + comes_furnished + laundry_options + parking_options + smoking_allowed", housing).fit()
# Fit model3
model3 = sm.OLS.from_formula("price ~ type + sqfeet + beds + baths + comes_furnished + laundry_options + parking_options + smoking_allowed + cats_allowed + dogs_allowed", housing).fit()
...
model2_train = sm.OLS.from_formula("price ~ type + sqfeet + beds + baths + comes_furnished + laundry_options + parking_options + smoking_allowed", housing_train).fit()
# Fit model3 with training data
model3_train = sm.OLS.from_formula("price ~ type + sqfeet + beds + baths + comes_furnished + laundry_options + parking_options + smoking_allowed + cats_allowed + dogs_allowed", housing_train).fit()
